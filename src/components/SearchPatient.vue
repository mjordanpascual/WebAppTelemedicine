<template>
    <q-input v-bind="{ ...defaultAttrs, ...$attrs, ...props }" v-on="$attrs" @click="dialog = true" />
  
    <q-dialog v-model="dialog">
      <q-card flat bordered style="max-width: 800px" class="q-mt-xl">
        <q-card-section>
          <div align="center" class="text-weight-bold text-size-16 letter-spacing-300 q-mt-md q-mb-lg">
        ...
        <q-card-section>
          <q-form class="row" @submit.prevent="search">
            <div class="col-12 col-sm-6 col-md-3 q-pa-xs">
              <CustomInput hide-bottom-space v-model="data.patlast" label="Last Name" />
            </div>
            <div class="col-12 col-sm-6 col-md-3 q-pa-xs">
              <CustomInput hide-bottom-space v-model="data.patfirst" label="First Name" />
            </div>
            <div class="col-12 col-sm-6 col-md-3 q-pa-xs">
              <CustomInput hide-bottom-space v-model="data.patmiddle" label="Middle Name" />
            </div>
            <div class="col-12 col-sm-6 col-md-3 q-pa-xs">
              <q-btn color="primary" class="full-width" type="submit" :loading="loading">
                Search
              </q-btn>
            </div>
          </q-form>
  ...
  const columns = [
    { name: 'hospital_number', label: 'Hospital Number', field: 'hospital_number', sortable: true },
    { name: 'patlast', label: 'Last Name', field: 'patlast', sortable: true },
    { name: 'patfirst', label: 'First Name', field: 'patfirst', sortable: true },
    { name: 'patmiddle', label: 'Middle Name', field: 'patmiddle', sortable: true },
    { name: 'patsuffix', label: 'Suffix Name', field: 'patsuffix', sortable: true },
